...
GROQ_API_KEY = os.getenv("GROQ_API_KEY")
GROQ_EMBEDDING_ENDPOINT = "https://api.groq.ai/v1/embeddings"  # Update if Groq changes
...
class GroqEmbeddings(Embeddings):
    ...
    def _embed_text(self, text):
        ...
        payload = {
            "input": text,
            "model": "groq-embedding-1",  # Replace with real model if needed
        }
        ...
        # Attempt both ways of retrieving embedding
...
# Lazy load Groq embedding wrapper
@lru_cache()
def get_groq_embeddings():
